...
const (
	gwHost            = "http://localhost:8080/"
	upHost            = "http://localhost:28080/"
	dlHost            = "http://localhost:38080/"
	apiUserSignin     = gwHost + "user/signin"
	apiUploadInit     = upHost + "file/mpupload/init"
	apiUploadPart     = upHost + "file/mpupload/uppart"
	apiUploadComplete = upHost + "file/mpupload/complete"
	apiUploadCancel   = upHost + "file/mpupload/cancel"
)
